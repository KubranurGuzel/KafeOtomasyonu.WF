...
{
    public partial class frmpersonelperformansraporu : Form
    {
        public frmpersonelperformansraporu()
        {
            InitializeComponent();
        }

        private void frmpersonelperformansraporu_Load(object sender, EventArgs e)
        {
